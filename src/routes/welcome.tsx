...
const pillars = [
  { t: "Stream on Sheba", d: "A player that stays with you. Background audio, queue, and a catalog that is actually owned." },
  { t: "Promote on YouTube", d: "Paste an official YouTube URL. Sheba pulls the title and thumbnail, then sends fans to YouTube’s player — never a rip." },
  { t: "Sell & show up", d: "Artists set the price. Tickets with random QR codes. Sheba Live PPV with short-lived tokens." },
    ...
    <main className="min-h-dvh bg-background text-foreground">
      ...
      <section className="relative overflow-hidden px-6 py-16 md:px-12 md:py-24">
        ...
        <div className="relative max-w-2xl">
          <p className="text-xs tracking-[0.25em] text-sand uppercase">Accra · Lagos · Johannesburg · Dakar</p>
        ...
        <div className="overflow-hidden rounded-[28px] bg-secondary md:grid md:grid-cols-2">
          ...
          <div className="p-8 md:p-12">
            ...
            <p className="mt-3 text-sm leading-relaxed text-muted-foreground">
              Two distribution lanes. Upload a master to Sheba for streaming, free or paid download.
              Or paste your official YouTube music link and run a promotion — discovery, profile, and
              Sheba-measured clicks, never invented YouTube view counts. Register as a fan, artist,
